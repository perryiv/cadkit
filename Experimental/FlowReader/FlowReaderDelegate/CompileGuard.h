...
#ifndef _FLOW_READER_DELEGATE_COMPILE_GUARD_H_
#define _FLOW_READER_DELEGATE_COMPILE_GUARD_H_

#ifndef _COMPILING_FLOW_READER_DELEGATE
# error "This header file is only used for compiling the library."
# error "It should not be included in client code."
#endif

#endif // _CFLOW_READER_DELEGATE_COMPILE_GUARD_H_
