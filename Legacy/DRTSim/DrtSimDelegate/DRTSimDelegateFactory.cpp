...
#include "DRTSimDelegateFactory.h"
#include "DRTSimDelegateComponent.h"

#include "Usul/Components/Create.h"

USUL_IMPLEMENT_IUNKNOWN_MEMBERS ( DRTSimDelegateFactory, DRTSimDelegateFactory::BaseClass );
...
{
  Usul::Interfaces::IClassFactory::ValidRefPtr factory ( new DRTSimDelegateFactory() );
...
DRTSimDelegateFactory::DRTSimDelegateFactory() : BaseClass()
{
}
...
DRTSimDelegateFactory::~DRTSimDelegateFactory()
{
}
...
Usul::Interfaces::IUnknown *DRTSimDelegateFactory::queryInterface ( unsigned long iid )
{
  switch ( iid )
  {
...
Usul::Interfaces::IUnknown *DRTSimDelegateFactory::createInstance ( unsigned long iid )
{
  // Require this to construct.
  DRTSimDelegateComponent::ValidAccessRefPtr component ( new DRTSimDelegateComponent() );
