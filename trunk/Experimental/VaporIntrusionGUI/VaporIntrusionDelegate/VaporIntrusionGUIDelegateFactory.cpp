...
#include "VaporIntrusionGUIDelegateFactory.h"
#include "VaporIntrusionGUIDelegateComponent.h"

#include "Usul/Components/Create.h"

USUL_IMPLEMENT_IUNKNOWN_MEMBERS ( VaporIntrusionGUIDelegateFactory, VaporIntrusionGUIDelegateFactory::BaseClass );
...
{
  Usul::Interfaces::IClassFactory::ValidRefPtr factory ( new VaporIntrusionGUIDelegateFactory() );
...
VaporIntrusionGUIDelegateFactory::VaporIntrusionGUIDelegateFactory() : BaseClass()
{
}
...
VaporIntrusionGUIDelegateFactory::~VaporIntrusionGUIDelegateFactory()
{
}
...
Usul::Interfaces::IUnknown *VaporIntrusionGUIDelegateFactory::queryInterface ( unsigned long iid )
{
  switch ( iid )
  {
...
Usul::Interfaces::IUnknown *VaporIntrusionGUIDelegateFactory::createInstance ( unsigned long iid )
{
  // Require this to construct.
  VaporIntrusionGUIDelegateComponent::ValidAccessRefPtr component ( new VaporIntrusionGUIDelegateComponent() );
