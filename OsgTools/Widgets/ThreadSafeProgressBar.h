...
class OSG_TOOLS_EXPORT ThreadSafeProgressBar : public Usul::Base::Object,
...
public:
  ...
  USUL_DECLARE_QUERY_POINTERS ( ThreadSafeProgressBar );
...
private:
  ...
  ThreadSafeProgressBar ( const ThreadSafeProgressBar & );
  ThreadSafeProgressBar &operator = ( const ThreadSafeProgressBar & );
