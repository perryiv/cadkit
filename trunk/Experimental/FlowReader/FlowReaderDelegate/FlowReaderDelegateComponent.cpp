...
USUL_IMPLEMENT_IUNKNOWN_MEMBERS ( FlowReaderDelegateComponent, FlowReaderDelegateComponent::BaseClass );
...
FlowReaderDelegateComponent::FlowReaderDelegateComponent() : BaseClass()
{
}
...
FlowReaderDelegateComponent::~FlowReaderDelegateComponent()
{
}
...
Usul::Interfaces::IUnknown *FlowReaderDelegateComponent::queryInterface ( unsigned long iid )
{
  switch ( iid )
  {
...
bool FlowReaderDelegateComponent::doesHandle( const std::string& token ) const
{
...
void FlowReaderDelegateComponent::createDefaultGUI ( Usul::Documents::Document *document, Usul::Interfaces::IUnknown* caller )
{
