...
#include "FlowReaderDelegateFactory.h"
#include "FlowReaderDelegateComponent.h"

#include "Usul/Components/Create.h"

USUL_IMPLEMENT_IUNKNOWN_MEMBERS ( FlowReaderDelegateFactory, FlowReaderDelegateFactory::BaseClass );
...
{
  Usul::Interfaces::IClassFactory::ValidRefPtr factory ( new FlowReaderDelegateFactory() );
...
FlowReaderDelegateFactory::FlowReaderDelegateFactory() : BaseClass()
{
}
...
FlowReaderDelegateFactory::~FlowReaderDelegateFactory()
{
}
...
Usul::Interfaces::IUnknown *FlowReaderDelegateFactory::queryInterface ( unsigned long iid )
{
  switch ( iid )
  {
...
Usul::Interfaces::IUnknown *FlowReaderDelegateFactory::createInstance ( unsigned long iid )
{
  // Require this to construct.
  FlowReaderDelegateComponent::ValidAccessRefPtr component ( new FlowReaderDelegateComponent() );
