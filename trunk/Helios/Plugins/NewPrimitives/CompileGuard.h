...
#ifndef __NEW_PRIMITIVES_COMPILE_GUARD_H__
#define __NEW_PRIMITIVES_COMPILE_GUARD_H__

#ifndef _COMPILING_NEW_PRIMITIVES
# error "This header file is only used for compiling the library."
# error "It should not be included in client code."
#endif

#endif /* __NEW_PRIMITIVES_COMPILE_GUARD_H__ */
