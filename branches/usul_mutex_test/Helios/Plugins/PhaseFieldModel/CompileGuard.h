...
#ifndef __PHASEFIELDMODEL_COMPILE_GUARD_H__
#define __PHASEFIELDMODEL_COMPILE_GUARD_H__

#ifndef _COMPILING_PHASEFIELDMODEL
# error "This header file is only used for compiling the library."
# error "It should not be included in client code."
#endif

#endif /* __PHASEFIELDMODEL_COMPILE_GUARD_H__ */
