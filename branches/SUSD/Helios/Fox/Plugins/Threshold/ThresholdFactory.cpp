...
USUL_IMPLEMENT_IUNKNOWN_MEMBERS ( ThresholdFactory, ThresholdFactory::BaseClass );
...
{
  Usul::Interfaces::IClassFactory::ValidRefPtr factory ( new ThresholdFactory() );
...
ThresholdFactory::ThresholdFactory() : BaseClass()
{
}
...
Usul::Interfaces::IUnknown *ThresholdFactory::queryInterface ( unsigned long iid )
{
  switch ( iid )
  {
...
Usul::Interfaces::IUnknown *ThresholdFactory::createInstance ( unsigned long iid )
{
  // Require this to construct.
  ThresholdComponent::ValidAccessRefPtr component ( new ThresholdComponent() );
