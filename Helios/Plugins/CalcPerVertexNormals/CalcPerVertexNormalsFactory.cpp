...
#include "CalcPerVertexNormalsFactory.h"
#include "Usul/Components/Create.h"

#include "CalcPerVertexNormalsComponent.h"

USUL_IMPLEMENT_IUNKNOWN_MEMBERS ( CalcPerVertexNormalsFactory, CalcPerVertexNormalsFactory::BaseClass );
...
{
  Usul::Interfaces::IClassFactory::ValidRefPtr factory ( new CalcPerVertexNormalsFactory() );
...
CalcPerVertexNormalsFactory::CalcPerVertexNormalsFactory() : BaseClass()
{
}
...
CalcPerVertexNormalsFactory::~CalcPerVertexNormalsFactory()
{
}
...
Usul::Interfaces::IUnknown *CalcPerVertexNormalsFactory::queryInterface ( unsigned long iid )
{
  switch ( iid )
  {
...
Usul::Interfaces::IUnknown *CalcPerVertexNormalsFactory::createInstance ( unsigned long iid )
{
  // Require this to construct.
  CalcPerVertexNormalsComponent::ValidAccessRefPtr component ( new CalcPerVertexNormalsComponent() );
