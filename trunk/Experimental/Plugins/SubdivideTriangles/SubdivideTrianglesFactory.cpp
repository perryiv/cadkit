...
#include "SubdivideTrianglesFactory.h"
#include "SubdivideTrianglesComponent.h"
#include "Usul/Components/Create.h"



USUL_IMPLEMENT_IUNKNOWN_MEMBERS ( SubdivideTrianglesFactory, SubdivideTrianglesFactory::BaseClass );
...
{
  Usul::Interfaces::IClassFactory::ValidRefPtr factory ( new SubdivideTrianglesFactory() );
...
SubdivideTrianglesFactory::SubdivideTrianglesFactory() : BaseClass()
{
}
...
SubdivideTrianglesFactory::~SubdivideTrianglesFactory()
{
}
...
Usul::Interfaces::IUnknown *SubdivideTrianglesFactory::queryInterface ( unsigned long iid )
{
  switch ( iid )
  {
...
Usul::Interfaces::IUnknown *SubdivideTrianglesFactory::createInstance ( unsigned long iid )
{
  // Require this to construct.
  SubdivideTrianglesComponent::ValidAccessRefPtr component ( new SubdivideTrianglesComponent() );
