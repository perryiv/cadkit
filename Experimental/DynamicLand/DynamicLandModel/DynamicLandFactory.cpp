...
#include "DynamicLandFactory.h"
#include "DynamicLandComponent.h"

#include "Usul/Components/Create.h"

USUL_IMPLEMENT_IUNKNOWN_MEMBERS ( DynamicLandFactory, DynamicLandFactory::BaseClass );
...
{
  Usul::Interfaces::IClassFactory::ValidRefPtr factory ( new DynamicLandFactory() );
...
DynamicLandFactory::DynamicLandFactory() : BaseClass()
{
}
...
DynamicLandFactory::~DynamicLandFactory()
{
}
...
Usul::Interfaces::IUnknown *DynamicLandFactory::queryInterface ( unsigned long iid )
{
  switch ( iid )
  {
...
Usul::Interfaces::IUnknown *DynamicLandFactory::createInstance ( unsigned long iid )
{
  // Require this to construct.
  DynamicLandComponent::ValidAccessRefPtr component ( new DynamicLandComponent() );
