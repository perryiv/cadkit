...
#include "CFDVizDelegateFactory.h"
#include "CFDVizDelegateComponent.h"

#include "Usul/Components/Create.h"

USUL_IMPLEMENT_IUNKNOWN_MEMBERS ( CFDVizDelegateFactory, CFDVizDelegateFactory::BaseClass );
...
{
  Usul::Interfaces::IClassFactory::ValidRefPtr factory ( new CFDVizDelegateFactory() );
...
CFDVizDelegateFactory::CFDVizDelegateFactory() : BaseClass()
{
}
...
CFDVizDelegateFactory::~CFDVizDelegateFactory()
{
}
...
Usul::Interfaces::IUnknown *CFDVizDelegateFactory::queryInterface ( unsigned long iid )
{
  switch ( iid )
  {
...
Usul::Interfaces::IUnknown *CFDVizDelegateFactory::createInstance ( unsigned long iid )
{
  // Require this to construct.
  CFDVizDelegateComponent::ValidAccessRefPtr component ( new CFDVizDelegateComponent() );
