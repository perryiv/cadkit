...
#include "MOVWriterFactory.h"
#include "MOVWriterComponent.h"
#include "Usul/Components/Create.h"



USUL_IMPLEMENT_IUNKNOWN_MEMBERS ( MOVWriterFactory, MOVWriterFactory::BaseClass );
...
{
  Usul::Interfaces::IClassFactory::ValidRefPtr factory ( new MOVWriterFactory() );
...
MOVWriterFactory::MOVWriterFactory() : BaseClass()
{
}
...
MOVWriterFactory::~MOVWriterFactory()
{
}
...
Usul::Interfaces::IUnknown *MOVWriterFactory::queryInterface ( unsigned long iid )
{
  switch ( iid )
  {
...
Usul::Interfaces::IUnknown *MOVWriterFactory::createInstance ( unsigned long iid )
{
  // Require this to construct.
  MOVWriterComponent::ValidAccessRefPtr component ( new MOVWriterComponent() );
