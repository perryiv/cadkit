...
#include "NewPrimitivesFactory.h"
#include "NewPrimitivesComponent.h"
#include "Usul/Components/Create.h"



USUL_IMPLEMENT_IUNKNOWN_MEMBERS ( NewPrimitivesFactory, NewPrimitivesFactory::BaseClass );
...
{
  Usul::Interfaces::IClassFactory::ValidRefPtr factory ( new NewPrimitivesFactory() );
...
NewPrimitivesFactory::NewPrimitivesFactory() : BaseClass()
{
}
...
NewPrimitivesFactory::~NewPrimitivesFactory()
{
}
...
Usul::Interfaces::IUnknown *NewPrimitivesFactory::queryInterface ( unsigned long iid )
{
  switch ( iid )
  {
...
Usul::Interfaces::IUnknown *NewPrimitivesFactory::createInstance ( unsigned long iid )
{
  // Require this to construct.
  NewPrimitivesComponent::ValidAccessRefPtr component ( new NewPrimitivesComponent() );
