...
#include "InvertImageFactory.h"
#include "InvertImageComponent.h"

#include "Usul/Components/Create.h"


USUL_IMPLEMENT_IUNKNOWN_MEMBERS ( InvertImageFactory, InvertImageFactory::BaseClass );
...
{
  Usul::Interfaces::IClassFactory::ValidRefPtr factory ( new InvertImageFactory() );
...
InvertImageFactory::InvertImageFactory() : BaseClass()
{
}
...
InvertImageFactory::~InvertImageFactory()
{
}
...
Usul::Interfaces::IUnknown *InvertImageFactory::queryInterface ( unsigned long iid )
{
  switch ( iid )
  {
...
Usul::Interfaces::IUnknown *InvertImageFactory::createInstance ( unsigned long iid )
{
  // Require this to construct.
  InvertImageComponent::ValidAccessRefPtr component ( new InvertImageComponent() );
