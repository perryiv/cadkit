...
#ifndef _DIRECTX_JOYSTICK_COMPILE_GUARD_H_
#define _DIRECTX_JOYSTICK_COMPILE_GUARD_H_

#ifndef _COMPILING_DIRECTX_JOYSTICK
# error "This header file is only used for compiling the library."
# error "It should not be included in client code."
#endif

#endif // _DIRECTX_JOYSTICK_COMPILE_GUARD_H_
