...
#include "Minerva/Plugins/PostgresConnection/PostgresConnectionFactory.h"
#include "Minerva/Plugins/PostgresConnection/PostgresConnectionComponent.h"

#include "Usul/Components/Create.h"

USUL_IMPLEMENT_IUNKNOWN_MEMBERS ( PostgresConnectionFactory, PostgresConnectionFactory::BaseClass );
...
{
  Usul::Interfaces::IClassFactory::ValidRefPtr factory ( new PostgresConnectionFactory() );
...
PostgresConnectionFactory::PostgresConnectionFactory() : BaseClass()
{
}
...
Usul::Interfaces::IUnknown *PostgresConnectionFactory::queryInterface ( unsigned long iid )
{
  switch ( iid )
  {
...
Usul::Interfaces::IUnknown *PostgresConnectionFactory::createInstance ( unsigned long iid )
{
  // Require this to construct.
  PostgresConnectionComponent::ValidAccessRefPtr component ( new PostgresConnectionComponent );
