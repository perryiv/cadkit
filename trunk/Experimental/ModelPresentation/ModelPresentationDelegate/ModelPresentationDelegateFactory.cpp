...
#include "ModelPresentationDelegateFactory.h"
#include "ModelPresentationDelegateComponent.h"

#include "Usul/Components/Create.h"

USUL_IMPLEMENT_IUNKNOWN_MEMBERS ( ModelPresentationDelegateFactory, ModelPresentationDelegateFactory::BaseClass );
...
{
  Usul::Interfaces::IClassFactory::ValidRefPtr factory ( new ModelPresentationDelegateFactory() );
...
ModelPresentationDelegateFactory::ModelPresentationDelegateFactory() : BaseClass()
{
}
...
ModelPresentationDelegateFactory::~ModelPresentationDelegateFactory()
{
}
...
Usul::Interfaces::IUnknown *ModelPresentationDelegateFactory::queryInterface ( unsigned long iid )
{
  switch ( iid )
  {
...
Usul::Interfaces::IUnknown *ModelPresentationDelegateFactory::createInstance ( unsigned long iid )
{
  // Require this to construct.
  ModelPresentationDelegateComponent::ValidAccessRefPtr component ( new ModelPresentationDelegateComponent() );
