...
#include "HideShowNormalsFactory.h"
#include "Usul/Components/Create.h"
#include "HideShowNormalsComponent.h"



USUL_IMPLEMENT_IUNKNOWN_MEMBERS ( HideShowNormalsFactory, HideShowNormalsFactory::BaseClass );
...
{
  Usul::Interfaces::IClassFactory::ValidRefPtr factory ( new HideShowNormalsFactory() );
...
HideShowNormalsFactory::HideShowNormalsFactory() : BaseClass()
{
}
...
HideShowNormalsFactory::~HideShowNormalsFactory()
{
}
...
Usul::Interfaces::IUnknown *HideShowNormalsFactory::queryInterface ( unsigned long iid )
{
  switch ( iid )
  {
...
Usul::Interfaces::IUnknown *HideShowNormalsFactory::createInstance ( unsigned long iid )
{
  // Require this to construct.
  HideShowNormalsComponent::ValidAccessRefPtr component ( new HideShowNormalsComponent() );
