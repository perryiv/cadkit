...
#include "DecimateTrianglesFactory.h"
#include "DecimateTrianglesComponent.h"
#include "Usul/Components/Create.h"



USUL_IMPLEMENT_IUNKNOWN_MEMBERS ( DecimateTrianglesFactory, DecimateTrianglesFactory::BaseClass );
...
{
  Usul::Interfaces::IClassFactory::ValidRefPtr factory ( new DecimateTrianglesFactory() );
...
DecimateTrianglesFactory::DecimateTrianglesFactory() : BaseClass()
{
}
...
DecimateTrianglesFactory::~DecimateTrianglesFactory()
{
}
...
Usul::Interfaces::IUnknown *DecimateTrianglesFactory::queryInterface ( unsigned long iid )
{
  switch ( iid )
  {
...
Usul::Interfaces::IUnknown *DecimateTrianglesFactory::createInstance ( unsigned long iid )
{
  // Require this to construct.
  DecimateTrianglesComponent::ValidAccessRefPtr component ( new DecimateTrianglesComponent() );
