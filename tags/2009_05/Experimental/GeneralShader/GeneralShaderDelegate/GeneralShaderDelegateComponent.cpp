...
USUL_IMPLEMENT_IUNKNOWN_MEMBERS ( GeneralShaderDelegateComponent, GeneralShaderDelegateComponent::BaseClass );
...
GeneralShaderDelegateComponent::GeneralShaderDelegateComponent() : BaseClass()
{
}
...
GeneralShaderDelegateComponent::~GeneralShaderDelegateComponent()
{
}
...
Usul::Interfaces::IUnknown *GeneralShaderDelegateComponent::queryInterface ( unsigned long iid )
{
  switch ( iid )
  {
...
bool GeneralShaderDelegateComponent::doesHandle( const std::string& token ) const
{
  return ( token == "General Shader Document" );
}
...
void GeneralShaderDelegateComponent::createDefaultGUI ( Usul::Documents::Document *document, Usul::Interfaces::IUnknown* caller )
{
