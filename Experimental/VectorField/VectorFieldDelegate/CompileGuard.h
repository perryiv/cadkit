...
#ifndef _SCENE_DELEGATE_COMPILE_GUARD_H_
#define _SCENE_DELEGATE_COMPILE_GUARD_H_

#ifndef _COMPILING_VECTOR_FIELD_DELEGATE
# error "This header file is only used for compiling the library."
# error "It should not be included in client code."
#endif

#endif // _SCENE_DELEGATE_COMPILE_GUARD_H_
