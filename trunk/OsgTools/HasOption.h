...
bool has ( const ContainerType &container, const std::string &category, const std::string &option )
{
  ...
  {
    ContainerType::const_iterator i ( container.find ( category ) );
  ...
  {
    ContainerType::const_iterator i ( container.find ( Usul::Strings::upperCase ( category ) ) );
    if ( ( container.end() != i ) && ( Usul::Strings::upperCase ( i->second ) == upper ) )
      return true;
  }
  ...
  {
    ContainerType::const_iterator i ( container.find ( Usul::Strings::lowerCase ( category ) ) );
    if ( ( container.end() != i ) && ( Usul::Strings::upperCase ( i->second ) == upper ) )
      return true;
  }
