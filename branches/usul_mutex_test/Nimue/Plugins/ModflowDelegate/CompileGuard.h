...
#ifndef _MODFLOW_DELEGATE_COMPILE_GUARD_H_
#define _MODFLOW_DELEGATE_COMPILE_GUARD_H_

#ifndef _COMPILING_MODFLOW_DELEGATE
# error "This header file is only used for compiling the library."
# error "It should not be included in client code."
#endif

#endif // _MODFLOW_DELEGATE_COMPILE_GUARD_H_
