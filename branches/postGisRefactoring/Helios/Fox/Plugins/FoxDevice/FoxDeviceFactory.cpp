...
#include "FoxDeviceFactory.h"
#include "FoxDeviceComponent.h"

#include "Usul/Components/Create.h"

USUL_IMPLEMENT_IUNKNOWN_MEMBERS ( FoxDeviceFactory, FoxDeviceFactory::BaseClass );
USUL_IMPLEMENT_TYPE_ID ( FoxDeviceFactory );
...
{
  Usul::Interfaces::IClassFactory::ValidRefPtr factory ( new FoxDeviceFactory() );
...
FoxDeviceFactory::FoxDeviceFactory() : BaseClass()
{
}
...
FoxDeviceFactory::~FoxDeviceFactory()
{
}
...
Usul::Interfaces::IUnknown *FoxDeviceFactory::queryInterface ( unsigned long iid )
{
  switch ( iid )
  {
...
Usul::Interfaces::IUnknown *FoxDeviceFactory::createInstance ( unsigned long iid )
{
  // Require this to construct.
  FoxDeviceComponent::ValidAccessRefPtr component ( new FoxDeviceComponent() );
