...
# ADD CPP /nologo /MD /W3 /GR /GX /O2 /I "../" /D "_MBCS" /D "_USRDLL" /D "_CADKIT_USE_PRECOMPILED_HEADERS" /D "NDEBUG" /D "WIN32" /D "_WINDOWS" /D "_CADKIT_COMPILING_CONTROLLER_LIBRARY" /YX"CtPrecompiled.h" /FD /c
# SUBTRACT CPP /Fr
...
# ADD LINK32 DMDataTk40.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /dll /machine:I386 /out:"../bin/CkCt.dll" /libpath:"$(DMDTK_DEV_PATH)/lib/Windows"
...
# ADD LINK32 DMDataTk40.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /dll /debug /machine:I386 /out:"../bin/CkCtd.dll" /pdbtype:sept /libpath:"$(DMDTK_DEV_PATH)/lib/Windows"
