...
///////////////////////////////////////////////////////////////////////////////
//
//  DbOsgApi.h: Defines what DB_STL_API means.
//
///////////////////////////////////////////////////////////////////////////////
...
///////////////////////////////////////////////////////////////////////////////
//
//  Here we define what DB_STL_API means.
//
///////////////////////////////////////////////////////////////////////////////
...
#   define DB_STL_API __declspec(dllexport) // We are compiling this library so the classes are exported.
# else
#   define DB_STL_API __declspec(dllimport) // The classes will be imported into the client's code.
# endif
#else // _WIN32
# define DB_STL_API
#endif
