...
#include "WRFDelegateFactory.h"
#include "WRFDelegateComponent.h"

#include "Usul/Components/Create.h"

USUL_IMPLEMENT_IUNKNOWN_MEMBERS ( WRFDelegateFactory, WRFDelegateFactory::BaseClass );
...
{
  Usul::Interfaces::IClassFactory::ValidRefPtr factory ( new WRFDelegateFactory() );
...
WRFDelegateFactory::WRFDelegateFactory() : BaseClass()
{
}
...
WRFDelegateFactory::~WRFDelegateFactory()
{
}
...
Usul::Interfaces::IUnknown *WRFDelegateFactory::queryInterface ( unsigned long iid )
{
  switch ( iid )
  {
...
Usul::Interfaces::IUnknown *WRFDelegateFactory::createInstance ( unsigned long iid )
{
  // Require this to construct.
  WRFDelegateComponent::ValidAccessRefPtr component ( new WRFDelegateComponent() );
