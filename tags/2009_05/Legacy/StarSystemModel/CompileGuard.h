...
#ifndef _STAR_SYSTEM_MODEL_COMPILE_GUARD_H_
#define _STAR_SYSTEM_MODEL_COMPILE_GUARD_H_

#ifndef _COMPILING_STAR_SYSTEM_MODEL
# error "This header file is only used for compiling the library."
# error "It should not be included in client code."
#endif

#endif // _STAR_SYSTEM_MODEL_COMPILE_GUARD_H_
