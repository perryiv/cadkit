...
# ADD CPP /nologo /MD /W3 /GR /GX /O2 /I "../../" /I "$(DMDTK_DEV_PATH)/include" /D "_MBCS" /D "_USRDLL" /D "_CADKIT_USE_PRECOMPILED_HEADERS" /D "NDEBUG" /D "WIN32" /D "_WINDOWS" /D "_CADKIT_COMPILING_DATABASE_JUPITER_LIBRARY" /Fr /YX"DbJtPrecompiled.h" /FD /c
...
# ADD CPP /nologo /MDd /W3 /Gm /GR /GX /ZI /Od /I "../../" /I "$(DMDTK_DEV_PATH)/include" /D "_USRDLL" /D "_MBCS" /D "_CADKIT_SL_PRINT_DEBUG" /D "_CADKIT_USE_PRECOMPILED_HEADERS" /D "WIN32" /D "_DEBUG" /D "_WINDOWS" /D "_CADKIT_COMPILING_DATABASE_JUPITER_LIBRARY" /Fr /YX"DbJtPrecompiled.h" /FD /GZ /c
