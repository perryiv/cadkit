...
USUL_IMPLEMENT_IUNKNOWN_MEMBERS ( GrayscaleFactory, GrayscaleFactory::BaseClass );
...
{
  Usul::Interfaces::IClassFactory::ValidRefPtr factory ( new GrayscaleFactory() );
...
GrayscaleFactory::GrayscaleFactory() : BaseClass()
{
}
...
Usul::Interfaces::IUnknown *GrayscaleFactory::queryInterface ( unsigned long iid )
{
  switch ( iid )
  {
...
Usul::Interfaces::IUnknown *GrayscaleFactory::createInstance ( unsigned long iid )
{
  // Require this to construct.
  GrayscaleComponent::ValidAccessRefPtr component ( new GrayscaleComponent() );
