...
#ifndef _CALCULATE_ENERGY_COMPILE_GUARD_H_
#define _CALCULATE_ENERGY_COMPILE_GUARD_H_

#ifndef _COMPILING_CALCULATE_ENERGY
# error "This header file is only used for compiling the library."
# error "It should not be included in client code."
#endif

#endif // _CALCULATE_ENERGY_COMPILE_GUARD_H_
