...
///////////////////////////////////////////////////////////////////////////////
//
//  Factory class to create component.
//
///////////////////////////////////////////////////////////////////////////////

#include "DecimateModelFactory.h"
#include "DecimateModelComponent.h"
#include "Usul/Components/Create.h"


USUL_IMPLEMENT_IUNKNOWN_MEMBERS ( DecimateModelFactory, DecimateModelFactory::BaseClass );
...
{
  Usul::Interfaces::IClassFactory::ValidRefPtr factory ( new DecimateModelFactory() );
...
DecimateModelFactory::DecimateModelFactory() : BaseClass()
{
}
...
DecimateModelFactory::~DecimateModelFactory()
{
}
...
Usul::Interfaces::IUnknown *DecimateModelFactory::queryInterface ( unsigned long iid )
{
  switch ( iid )
  {
...
Usul::Interfaces::IUnknown *DecimateModelFactory::createInstance ( unsigned long iid )
{
  // Require this to construct.
  DecimateModelComponent::ValidAccessRefPtr component ( new DecimateModelComponent() );
