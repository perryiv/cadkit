...
# ADD CPP /nologo /MD /W3 /WX /GR /GX /O2 /I "../../" /I "$(OSGHOME)/include" /D "_MBCS" /D "_USRDLL" /D "_CADKIT_USE_PRECOMPILED_HEADERS" /D "NDEBUG" /D "WIN32" /D "_WINDOWS" /D "_CADKIT_COMPILING_DATABASE_OPEN_SCENE_GRAPH_LIBRARY" /YX"DbOsgPrecompiled.h" /FD /Zm200 /c
...
# ADD LINK32 osg.lib osgDB.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /dll /machine:I386 /out:"../../bin/CkDbOsg.dll" /libpath:"$(OSGHOME)/lib"
...
# ADD CPP /nologo /MDd /W3 /WX /Gm /GR /GX /Zi /Od /I "../../" /I "$(OSGHOME)/include" /D "_USRDLL" /D "_MBCS" /D "_CADKIT_USE_PRECOMPILED_HEADERS" /D "WIN32" /D "_DEBUG" /D "_WINDOWS" /D "_CADKIT_COMPILING_DATABASE_OPEN_SCENE_GRAPH_LIBRARY" /YX"DbOsgPrecompiled.h" /FD /GZ /Zm200 /c
# SUBTRACT CPP /Fr
...
# ADD LINK32 osgd.lib osgDBd.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /dll /debug /machine:I386 /out:"../../bin/CkDbOsgd.dll" /pdbtype:sept /libpath:"$(OSGHOME)/lib"
