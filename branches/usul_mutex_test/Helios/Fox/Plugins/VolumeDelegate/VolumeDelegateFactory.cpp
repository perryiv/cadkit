...
#include "VolumeDelegateFactory.h"
#include "VolumeDelegateComponent.h"

#include "Usul/Components/Create.h"

USUL_IMPLEMENT_IUNKNOWN_MEMBERS ( VolumeDelegateFactory, VolumeDelegateFactory::BaseClass );
...
{
  Usul::Interfaces::IClassFactory::ValidRefPtr factory ( new VolumeDelegateFactory() );
...
VolumeDelegateFactory::VolumeDelegateFactory() : BaseClass()
{
}
...
VolumeDelegateFactory::~VolumeDelegateFactory()
{
}
...
Usul::Interfaces::IUnknown *VolumeDelegateFactory::queryInterface ( unsigned long iid )
{
  switch ( iid )
  {
...
Usul::Interfaces::IUnknown *VolumeDelegateFactory::createInstance ( unsigned long iid )
{
  // Require this to construct.
  VolumeDelegateComponent::ValidAccessRefPtr component ( new VolumeDelegateComponent() );
