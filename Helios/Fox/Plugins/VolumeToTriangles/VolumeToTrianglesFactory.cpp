...
#include "VolumeToTrianglesFactory.h"
#include "Usul/Components/Create.h"
#include "VolumeToTrianglesComponent.h"



USUL_IMPLEMENT_IUNKNOWN_MEMBERS ( VolumeToTrianglesFactory, VolumeToTrianglesFactory::BaseClass );
...
{
  Usul::Interfaces::IClassFactory::ValidRefPtr factory ( new VolumeToTrianglesFactory() );
...
VolumeToTrianglesFactory::VolumeToTrianglesFactory() : BaseClass()
{
}
...
VolumeToTrianglesFactory::~VolumeToTrianglesFactory()
{
}
...
Usul::Interfaces::IUnknown *VolumeToTrianglesFactory::queryInterface ( unsigned long iid )
{
  switch ( iid )
  {
...
Usul::Interfaces::IUnknown *VolumeToTrianglesFactory::createInstance ( unsigned long iid )
{
  // Require this to construct.
  VolumeToTrianglesComponent::ValidAccessRefPtr component ( new VolumeToTrianglesComponent() );
