...
///////////////////////////////////////////////////////////////////////////////
//
//  PlayMovieFactory class.
//
///////////////////////////////////////////////////////////////////////////////

#include "Minerva/Plugins/PlayMovie/PlayMovieFactory.h"
#include "Minerva/Plugins/PlayMovie/PlayMovieComponent.h"

#include "Usul/Components/Create.h"

USUL_IMPLEMENT_IUNKNOWN_MEMBERS ( PlayMovieFactory, PlayMovieFactory::BaseClass );
...
{
  Usul::Interfaces::IClassFactory::ValidRefPtr factory ( new PlayMovieFactory() );
...
PlayMovieFactory::PlayMovieFactory() : BaseClass()
{
}
...
PlayMovieFactory::~PlayMovieFactory()
{
}
...
Usul::Interfaces::IUnknown *PlayMovieFactory::queryInterface ( unsigned long iid )
{
  switch ( iid )
  {
...
Usul::Interfaces::IUnknown *PlayMovieFactory::createInstance ( unsigned long iid )
{
  // Require this to construct.
  PlayMovieComponent::ValidAccessRefPtr component ( new PlayMovieComponent );
