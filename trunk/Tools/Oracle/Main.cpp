...
///////////////////////////////////////////////////////////////////////////////
//
//  The class that executes the program.
//
///////////////////////////////////////////////////////////////////////////////
...
std::ostream &Program::_getStream ( const std::string &name )
{
...
unsigned int Program::_getNumRowsToPrefetch() const
{
...
void Program::_processCommandLine()
{
...
void Program::_executeCommands ( Connection::RefPtr connection, std::ostream &out )
{
  // Check input.
  if ( false == connection.valid() )
...
Program::Result::RefPtr Program::_executeCommand ( Connection::RefPtr connection, const std::string &sql )
{
  // Check input.
  if ( false == connection.valid() )
...
void Program::writeError ( const std::string &s )
{
...
void Program::_writeResult ( Result::RefPtr result, std::ostream &out )
{
  // Handle no result.
...
int main ( int argc, char **argv )
{
  ...
  catch ( const Program::Usage & )
  {
    Usul::Functions::safeCall ( Usul::Adaptors::memberFunction ( &program, &Program::writeUsage ), "2462809390" );
  }
  catch ( const Usul::Exceptions::Exception &e )
  {
    ...
    Usul::Functions::safeCallR1 ( Usul::Adaptors::memberFunction ( &program, &Program::writeError ), message, "3951800720" );
  }
  ...
  catch ( ... )
  {
    ...
    Usul::Functions::safeCallR1 ( Usul::Adaptors::memberFunction ( &program, &Program::writeError ), message, "4032328237" );
  }
  return result;
}
