...
#include "ArcGenReaderWriterDelegateFactory.h"
#include "ArcGenReaderWriterDelegateComponent.h"

#include "Usul/Components/Create.h"

USUL_IMPLEMENT_IUNKNOWN_MEMBERS ( ArcGenReaderWriterDelegateFactory, ArcGenReaderWriterDelegateFactory::BaseClass );
...
{
  Usul::Interfaces::IClassFactory::ValidRefPtr factory ( new ArcGenReaderWriterDelegateFactory() );
...
ArcGenReaderWriterDelegateFactory::ArcGenReaderWriterDelegateFactory() : BaseClass()
{
}
...
ArcGenReaderWriterDelegateFactory::~ArcGenReaderWriterDelegateFactory()
{
}
...
Usul::Interfaces::IUnknown *ArcGenReaderWriterDelegateFactory::queryInterface ( unsigned long iid )
{
  switch ( iid )
  {
...
Usul::Interfaces::IUnknown *ArcGenReaderWriterDelegateFactory::createInstance ( unsigned long iid )
{
  // Require this to construct.
  ArcGenReaderWriterDelegateComponent::ValidAccessRefPtr component ( new ArcGenReaderWriterDelegateComponent() );
