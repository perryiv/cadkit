...
#ifndef _VOXEL_MODEL_COMPONENT_CLASS_H_
#define _VOXEL_MODEL_COMPONENT_CLASS_H_
...
class VoxelComponent : public Usul::Base::Referenced,
...
public:
  ...
  USUL_DECLARE_REF_POINTERS ( VoxelComponent );
  ...
  virtual std::string           getPluginName() const { return "Voxel Model"; }
...
protected: 
  ...
  VoxelComponent &operator = ( const VoxelComponent & );
...
#endif // _VOXEL_MODEL_COMPONENT_CLASS_H_
