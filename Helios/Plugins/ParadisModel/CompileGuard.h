...
#ifndef __PARADIS_MODEL_COMPILE_GUARD_H__
#define __PARADIS_MODEL_COMPILE_GUARD_H__

#ifndef _COMPILING_PARADIS_MODEL
# error "This header file is only used for compiling the library."
# error "It should not be included in client code."
#endif

#endif /* __PARADIS_MODEL_COMPILE_GUARD_H__ */
