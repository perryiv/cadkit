...
#ifndef __DECIMATE_MODEL_COMPILE_GUARD_H__
#define __DECIMATE_MODEL_COMPILE_GUARD_H__

#ifndef _COMPILING_DECIMATE_MODEL
# error "This header file is only used for compiling the library."
# error "It should not be included in client code."
#endif

#endif /* __DECIMATE_MODEL_COMPILE_GUARD_H__ */
