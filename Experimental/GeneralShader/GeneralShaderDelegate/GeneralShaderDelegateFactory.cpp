...
#include "GeneralShaderDelegateFactory.h"
#include "GeneralShaderDelegateComponent.h"

#include "Usul/Components/Create.h"

USUL_IMPLEMENT_IUNKNOWN_MEMBERS ( GeneralShaderDelegateFactory, GeneralShaderDelegateFactory::BaseClass );
...
{
  Usul::Interfaces::IClassFactory::ValidRefPtr factory ( new GeneralShaderDelegateFactory() );
...
GeneralShaderDelegateFactory::GeneralShaderDelegateFactory() : BaseClass()
{
}
...
GeneralShaderDelegateFactory::~GeneralShaderDelegateFactory()
{
}
...
Usul::Interfaces::IUnknown *GeneralShaderDelegateFactory::queryInterface ( unsigned long iid )
{
  switch ( iid )
  {
...
Usul::Interfaces::IUnknown *GeneralShaderDelegateFactory::createInstance ( unsigned long iid )
{
  // Require this to construct.
  GeneralShaderDelegateComponent::ValidAccessRefPtr component ( new GeneralShaderDelegateComponent() );
