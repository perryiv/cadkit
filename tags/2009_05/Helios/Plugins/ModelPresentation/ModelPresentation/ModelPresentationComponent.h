...
public:
  ...
  USUL_DECLARE_REF_POINTERS ( ModelPresentationComponent );
...
protected: 
  ...
  // Do not copy.
  ModelPresentationComponent ( const ModelPresentationComponent & );
  ModelPresentationComponent &operator = ( const ModelPresentationComponent & );

  /// Use reference counting.
  virtual ~ModelPresentationComponent();
