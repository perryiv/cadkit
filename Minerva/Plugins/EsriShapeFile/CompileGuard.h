...
#ifndef _ESRI_SHAPE_FILE_COMPILE_GUARD_H_
#define _ESRI_SHAPE_FILE_COMPILE_GUARD_H_

#ifndef _COMPILING_ESRI_SHAPE_FILE
# error "This header file is only used for compiling the library."
# error "It should not be included in client code."
#endif

#endif // _ESRI_SHAPE_FILE_COMPILE_GUARD_H_
