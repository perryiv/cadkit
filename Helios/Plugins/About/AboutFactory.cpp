...
#include "AboutFactory.h"
#include "Usul/Components/Create.h"
#include "AboutComponent.h"


USUL_IMPLEMENT_IUNKNOWN_MEMBERS ( AboutFactory, AboutFactory::BaseClass );
...
{
  Usul::Interfaces::IClassFactory::ValidRefPtr factory ( new AboutFactory() );
...
AboutFactory::AboutFactory() : BaseClass()
{
}
...
Usul::Interfaces::IUnknown *AboutFactory::queryInterface ( unsigned long iid )
{
  switch ( iid )
  {
...
Usul::Interfaces::IUnknown *AboutFactory::createInstance ( unsigned long iid )
{
  // Require this to construct.
  AboutComponent::ValidAccessRefPtr component ( new AboutComponent() );
