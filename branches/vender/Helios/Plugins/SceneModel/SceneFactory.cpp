...
USUL_IMPLEMENT_IUNKNOWN_MEMBERS ( SceneFactory, SceneFactory::BaseClass );
...
{
  Usul::Interfaces::IClassFactory::ValidRefPtr factory ( new SceneFactory() );
...
SceneFactory::SceneFactory() : BaseClass()
{
}
...
Usul::Interfaces::IUnknown *SceneFactory::queryInterface ( unsigned long iid )
{
  switch ( iid )
  {
...
Usul::Interfaces::IUnknown *SceneFactory::createInstance ( unsigned long iid )
{
  // Require this to construct.
  SceneComponent::ValidAccessRefPtr component ( new SceneComponent() );
