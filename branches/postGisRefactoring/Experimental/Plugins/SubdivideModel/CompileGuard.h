...
#ifndef __SUBDIVIDE_MODEL_COMPILE_GUARD_H__
#define __SUBDIVIDE_MODEL_COMPILE_GUARD_H__

#ifndef _COMPILING_SUBDIVIDE_MODEL
# error "This header file is only used for compiling the library."
# error "It should not be included in client code."
#endif

#endif /* __SUBDIVIDE_MODEL_COMPILE_GUARD_H__ */
