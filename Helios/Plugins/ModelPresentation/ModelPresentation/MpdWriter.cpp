...
void MpdWriter::_writeSets()
{
  ...
  {
     _mpdFile = Usul::Strings::format( _mpdFile, "  <set name=\"" , (*i).second.name , "\" menuName=\"" , (*i).second.menuName , "\" >\n" );
...
void MpdWriter::_writeTimeSets()
{
  ...
  {
    _mpdFile += "  <timeset name=\"" + (*i).second.name + "\" menuName=\"" + (*i).second.menuName + "\" endTime=\"" + (*i).second.endTime + "\" >\n";
...
void MpdWriter::_writeSequence()
{
  ...
  _mpdFile += "  <sequence name=\"" + _sequence.name + "\" menuName=\"" + _sequence.menuName + "\" >\n";
