...
#include "ViewTabFactory.h"
#include "Usul/Components/Create.h"
#include "ViewTabComponent.h"


USUL_IMPLEMENT_IUNKNOWN_MEMBERS ( ViewTabFactory, ViewTabFactory::BaseClass );
...
{
  Usul::Interfaces::IClassFactory::ValidRefPtr factory ( new ViewTabFactory() );
...
ViewTabFactory::ViewTabFactory() : BaseClass()
{
}
...
Usul::Interfaces::IUnknown *ViewTabFactory::queryInterface ( unsigned long iid )
{
  switch ( iid )
  {
...
Usul::Interfaces::IUnknown *ViewTabFactory::createInstance ( unsigned long iid )
{
  // Require this to construct.
  ViewTabComponent::ValidAccessRefPtr component ( new ViewTabComponent() );
