...
USUL_IMPLEMENT_IUNKNOWN_MEMBERS ( ItkFactory, ItkFactory::BaseClass );
...
{
  Usul::Interfaces::IClassFactory::ValidRefPtr factory ( new ItkFactory() );
...
ItkFactory::ItkFactory() : BaseClass()
{
}
...
Usul::Interfaces::IUnknown *ItkFactory::queryInterface ( unsigned long iid )
{
  switch ( iid )
  {
...
Usul::Interfaces::IUnknown *ItkFactory::createInstance ( unsigned long iid )
{
  // Require this to construct.
  ItkComponent::ValidAccessRefPtr component ( new ItkComponent() );
