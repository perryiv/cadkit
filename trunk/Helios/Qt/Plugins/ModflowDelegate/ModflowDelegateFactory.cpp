...
#include "ModflowDelegateFactory.h"
#include "ModflowDelegateComponent.h"

#include "Usul/Components/Create.h"
#include "Usul/Trace/Trace.h"

USUL_IMPLEMENT_IUNKNOWN_MEMBERS ( ModflowDelegateFactory, ModflowDelegateFactory::BaseClass );
...
{
  USUL_TRACE_SCOPE_STATIC;
  Usul::Interfaces::IClassFactory::ValidRefPtr factory ( new ModflowDelegateFactory() );
...
ModflowDelegateFactory::ModflowDelegateFactory() : BaseClass()
{
  USUL_TRACE_SCOPE;
}
...
ModflowDelegateFactory::~ModflowDelegateFactory()
{
  USUL_TRACE_SCOPE;
}
...
Usul::Interfaces::IUnknown *ModflowDelegateFactory::queryInterface ( unsigned long iid )
{
  USUL_TRACE_SCOPE;
...
Usul::Interfaces::IUnknown *ModflowDelegateFactory::createInstance ( unsigned long iid )
{
  USUL_TRACE_SCOPE;

  // Require this to construct.
  ModflowDelegateComponent::ValidAccessRefPtr component ( new ModflowDelegateComponent() );
