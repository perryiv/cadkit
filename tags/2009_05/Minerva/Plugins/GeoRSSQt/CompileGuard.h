...
#ifndef _GEO_RSS_LAYER_QT_COMPILE_GUARD_H_
#define _GEO_RSS_LAYER_QT_COMPILE_GUARD_H_

#ifndef _COMPILING_GEO_RSS_LAYER_QT
# error "This header file is only used for compiling the library."
# error "It should not be included in client code."
#endif

#endif // _GEO_RSS_LAYER_QT_COMPILE_GUARD_H_
