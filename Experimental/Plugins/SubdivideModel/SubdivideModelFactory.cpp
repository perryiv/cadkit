...
#include "SubdivideModelFactory.h"
#include "SubdivideModelComponent.h"
#include "Usul/Components/Create.h"



USUL_IMPLEMENT_IUNKNOWN_MEMBERS ( SubdivideModelFactory, SubdivideModelFactory::BaseClass );
...
{
  Usul::Interfaces::IClassFactory::ValidRefPtr factory ( new SubdivideModelFactory() );
...
SubdivideModelFactory::SubdivideModelFactory() : BaseClass()
{
}
...
SubdivideModelFactory::~SubdivideModelFactory()
{
}
...
Usul::Interfaces::IUnknown *SubdivideModelFactory::queryInterface ( unsigned long iid )
{
  switch ( iid )
  {
...
Usul::Interfaces::IUnknown *SubdivideModelFactory::createInstance ( unsigned long iid )
{
  // Require this to construct.
  SubdivideModelComponent::ValidAccessRefPtr component ( new SubdivideModelComponent() );
