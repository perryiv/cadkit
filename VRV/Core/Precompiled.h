...
#ifndef _VIRTUAL_REALITY_VIEWER_INTERNAL_PRECOMPILED_HEADERS_H_
#define _VIRTUAL_REALITY_VIEWER_INTERNAL_PRECOMPILED_HEADERS_H_

#ifndef _COMPILING_VRV
...
#endif // _VIRTUAL_REALITY_VIEWER_INTERNAL_PRECOMPILED_HEADERS_H_
