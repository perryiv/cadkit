...
#include "Helios/Plugins/TriangleModel/TriangleComponent.h"
...
{
  Usul::Interfaces::IClassFactory::ValidRefPtr factory ( new Usul::Components::Factory<TriangleComponent>() );
