...
DynamicLandComponent::DynamicLandComponent() : BaseClass()
{
}
...
DynamicLandComponent::~DynamicLandComponent()
{
}
...
Usul::Interfaces::IUnknown *DynamicLandComponent::queryInterface ( unsigned long iid )
{
  switch ( iid )
  {
...
Usul::Documents::Document *DynamicLandComponent::createDocument ( Unknown *caller )
{
