...
#include "Animate/AnimateFactory.h"
...
USUL_IMPLEMENT_IUNKNOWN_MEMBERS ( AnimateFactory, AnimateFactory::BaseClass );
...
{
  Usul::Interfaces::IClassFactory::ValidRefPtr factory ( new AnimateFactory() );
...
AnimateFactory::AnimateFactory() : BaseClass()
{
}
...
Usul::Interfaces::IUnknown *AnimateFactory::queryInterface ( unsigned long iid )
{
  switch ( iid )
  {
...
Usul::Interfaces::IUnknown *AnimateFactory::createInstance ( unsigned long iid )
{
  // Construct component.
  Animate::AnimateComponent::ValidAccessRefPtr component ( new Animate::AnimateComponent() );
