...
#ifndef _CFD_VIZ_DELEGATE_COMPILE_GUARD_H_
#define _CFD_VIZ_DELEGATE_COMPILE_GUARD_H_

#ifndef _COMPILING_CFD_VIZ_DELEGATE
# error "This header file is only used for compiling the library."
# error "It should not be included in client code."
#endif

#endif // _CFD_VIZ_DELEGATE_COMPILE_GUARD_H_
