...
# ADD CPP /nologo /MD /W3 /GR /GX /I "../../../" /I "$(FOX_INCLUDE_DIR)" /I "../" /D "_WINDOWS" /D "WIN32" /D "NDEBUG" /D "FOXDLL" /D "HAVE_OPENGL" /FD /c
# SUBTRACT CPP /YX
...
# ADD LINK32 foxdll.lib comctl32.lib kernel32.lib user32.lib gdi32.lib advapi32.lib shell32.lib wsock32.lib ole32.lib /nologo /entry:"mainCRTStartup" /subsystem:windows /machine:I386 /out:"../../../bin/foxcube.exe" /libpath:"$(FOX_LIB_DIR)"
...
# ADD LINK32 foxdlld.lib comctl32.lib wsock32.lib ws2_32.lib kernel32.lib user32.lib gdi32.lib advapi32.lib shell32.lib ole32.lib /nologo /entry:"mainCRTStartup" /subsystem:windows /debug /machine:I386 /out:"../../../bin/foxcubed.exe" /pdbtype:sept /libpath:"$(FOX_LIB_DIR)"
