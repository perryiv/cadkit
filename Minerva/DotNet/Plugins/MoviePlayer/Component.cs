...
namespace DT.Minerva.Plugins.MoviePlayer
{
    ...
    CadKit.Interfaces.IPlugin
  {
    ...
    private void _parentShown(object sender, System.EventArgs args)
    {
      try
      {
        DT.Minerva.Plugins.MoviePlayer.MoviePlayer form = new DT.Minerva.Plugins.MoviePlayer.MoviePlayer();
        System.Windows.Forms.Form parent = sender as System.Windows.Forms.Form;
        CadKit.Tools.ToolWindow.configure(form, parent, "MoviePlayer", false);
    ...
    private static void _configureDockWindow(object sender, DT.Minerva.Plugins.MoviePlayer.MoviePlayer form)
    {
      ...
      if (null != dockPanel)
      {
        ...
        if (null != panel)
        {
          ...
          if (null != register)
            register.registerPersistanceForm(typeof(DT.Minerva.Plugins.MoviePlayer.MoviePlayer).ToString(), form);
    ...
    {
      get { lock (_mutex) { return "MoviePlayer"; } }
    }
    ...
    {
      get { lock (_mutex) { return "Play movie in the scene"; } }
    }
  }
}
