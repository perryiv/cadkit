...
{
  Usul::Interfaces::IClassFactory::ValidRefPtr factory ( new EditPolygonFactory() );
...
EditPolygonFactory::EditPolygonFactory() : BaseClass()
{
}
...
EditPolygonFactory::~EditPolygonFactory()
{
}
...
Usul::Interfaces::IUnknown *EditPolygonFactory::queryInterface ( unsigned long iid )
{
  switch ( iid )
  {
...
Usul::Interfaces::IUnknown *EditPolygonFactory::createInstance ( unsigned long iid )
{
  ...
  EditPolygonComponent::ValidAccessRefPtr component ( new EditPolygonComponent() );
