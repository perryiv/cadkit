...
#include "GroupPrimitivesFactory.h"
#include "GroupPrimitivesComponent.h"
#include "Usul/Components/Create.h"



USUL_IMPLEMENT_IUNKNOWN_MEMBERS ( GroupPrimitivesFactory, GroupPrimitivesFactory::BaseClass );
...
{
  Usul::Interfaces::IClassFactory::ValidRefPtr factory ( new GroupPrimitivesFactory() );
...
GroupPrimitivesFactory::GroupPrimitivesFactory() : BaseClass()
{
}
...
GroupPrimitivesFactory::~GroupPrimitivesFactory()
{
}
...
Usul::Interfaces::IUnknown *GroupPrimitivesFactory::queryInterface ( unsigned long iid )
{
  switch ( iid )
  {
...
Usul::Interfaces::IUnknown *GroupPrimitivesFactory::createInstance ( unsigned long iid )
{
  // Require this to construct.
  GroupPrimitivesComponent::ValidAccessRefPtr component ( new GroupPrimitivesComponent() );
