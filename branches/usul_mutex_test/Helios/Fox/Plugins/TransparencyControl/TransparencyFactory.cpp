...
#include "TransparencyFactory.h"
#include "TransparencyComponent.h"

#include "Usul/Components/Create.h"


USUL_IMPLEMENT_IUNKNOWN_MEMBERS ( TransparencyFactory, TransparencyFactory::BaseClass );
...
{
  Usul::Interfaces::IClassFactory::ValidRefPtr factory ( new TransparencyFactory() );
...
TransparencyFactory::TransparencyFactory() : BaseClass()
{
}
...
TransparencyFactory::~TransparencyFactory()
{
}
...
Usul::Interfaces::IUnknown *TransparencyFactory::queryInterface ( unsigned long iid )
{
  switch ( iid )
  {
...
Usul::Interfaces::IUnknown *TransparencyFactory::createInstance ( unsigned long iid )
{
  // Require this to construct.
  TransparencyComponent::ValidAccessRefPtr component ( new TransparencyComponent() );
