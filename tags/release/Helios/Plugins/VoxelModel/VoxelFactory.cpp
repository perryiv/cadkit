...
USUL_IMPLEMENT_IUNKNOWN_MEMBERS ( VoxelFactory, VoxelFactory::BaseClass );
...
{
  Usul::Interfaces::IClassFactory::ValidRefPtr factory ( new VoxelFactory() );
...
VoxelFactory::VoxelFactory() : BaseClass()
{
}
...
Usul::Interfaces::IUnknown *VoxelFactory::queryInterface ( unsigned long iid )
{
  switch ( iid )
  {
...
Usul::Interfaces::IUnknown *VoxelFactory::createInstance ( unsigned long iid )
{
  // Require this to construct.
  VoxelComponent::ValidAccessRefPtr component ( new VoxelComponent() );
