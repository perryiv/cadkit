...
#include "SceneDelegateFactory.h"
#include "SceneDelegateComponent.h"

#include "Usul/Components/Create.h"

USUL_IMPLEMENT_IUNKNOWN_MEMBERS ( SceneDelegateFactory, SceneDelegateFactory::BaseClass );
...
{
  Usul::Interfaces::IClassFactory::ValidRefPtr factory ( new SceneDelegateFactory() );
...
SceneDelegateFactory::SceneDelegateFactory() : BaseClass()
{
}
...
SceneDelegateFactory::~SceneDelegateFactory()
{
}
...
Usul::Interfaces::IUnknown *SceneDelegateFactory::queryInterface ( unsigned long iid )
{
  switch ( iid )
  {
...
Usul::Interfaces::IUnknown *SceneDelegateFactory::createInstance ( unsigned long iid )
{
  // Require this to construct.
  SceneDelegateComponent::ValidAccessRefPtr component ( new SceneDelegateComponent() );
