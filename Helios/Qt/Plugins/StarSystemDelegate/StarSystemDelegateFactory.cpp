...
#include "StarSystemDelegateFactory.h"
#include "StarSystemDelegateComponent.h"

#include "Usul/Components/Create.h"
#include "Usul/Trace/Trace.h"

USUL_IMPLEMENT_IUNKNOWN_MEMBERS ( StarSystemDelegateFactory, StarSystemDelegateFactory::BaseClass );
...
{
  USUL_TRACE_SCOPE_STATIC;
  Usul::Interfaces::IClassFactory::ValidRefPtr factory ( new StarSystemDelegateFactory() );
...
StarSystemDelegateFactory::StarSystemDelegateFactory() : BaseClass()
{
  USUL_TRACE_SCOPE;
}
...
StarSystemDelegateFactory::~StarSystemDelegateFactory()
{
  USUL_TRACE_SCOPE;
}
...
Usul::Interfaces::IUnknown *StarSystemDelegateFactory::queryInterface ( unsigned long iid )
{
  USUL_TRACE_SCOPE;
...
Usul::Interfaces::IUnknown *StarSystemDelegateFactory::createInstance ( unsigned long iid )
{
  USUL_TRACE_SCOPE;

  // Require this to construct.
  StarSystemDelegateComponent::ValidAccessRefPtr component ( new StarSystemDelegateComponent() );
