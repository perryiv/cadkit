...
#include "ScaleImageFactory.h"
#include "ScaleImageComponent.h"

#include "Usul/Components/Create.h"


USUL_IMPLEMENT_IUNKNOWN_MEMBERS ( ScaleImageFactory, ScaleImageFactory::BaseClass );
...
{
  Usul::Interfaces::IClassFactory::ValidRefPtr factory ( new ScaleImageFactory() );
...
ScaleImageFactory::ScaleImageFactory() : BaseClass()
{
}
...
ScaleImageFactory::~ScaleImageFactory()
{
}
...
Usul::Interfaces::IUnknown *ScaleImageFactory::queryInterface ( unsigned long iid )
{
  switch ( iid )
  {
...
Usul::Interfaces::IUnknown *ScaleImageFactory::createInstance ( unsigned long iid )
{
  // Require this to construct.
  ScaleImageComponent::ValidAccessRefPtr component ( new ScaleImageComponent() );
