...
#include "FieldViewReaderDelegateFactory.h"
#include "FieldViewReaderDelegateComponent.h"

#include "Usul/Components/Create.h"

USUL_IMPLEMENT_IUNKNOWN_MEMBERS ( FieldViewReaderDelegateFactory, FieldViewReaderDelegateFactory::BaseClass );
...
{
  Usul::Interfaces::IClassFactory::ValidRefPtr factory ( new FieldViewReaderDelegateFactory() );
...
FieldViewReaderDelegateFactory::FieldViewReaderDelegateFactory() : BaseClass()
{
}
...
FieldViewReaderDelegateFactory::~FieldViewReaderDelegateFactory()
{
}
...
Usul::Interfaces::IUnknown *FieldViewReaderDelegateFactory::queryInterface ( unsigned long iid )
{
  switch ( iid )
  {
...
Usul::Interfaces::IUnknown *FieldViewReaderDelegateFactory::createInstance ( unsigned long iid )
{
  // Require this to construct.
  FieldViewReaderDelegateComponent::ValidAccessRefPtr component ( new FieldViewReaderDelegateComponent() );
