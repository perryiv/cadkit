...
#ifndef _ANIMATION_CONTROL_COMPILE_GUARD_H_
#define _ANIMATION_CONTROL_COMPILE_GUARD_H_

#ifndef _COMPILING_ANIMATION_CONTROL
# error "This header file is only used for compiling the library."
# error "It should not be included in client code."
#endif

#endif // _ANIMATION_CONTROL_COMPILE_GUARD_H_
