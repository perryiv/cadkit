...
USUL_IMPLEMENT_IUNKNOWN_MEMBERS ( SnapShotFactory, SnapShotFactory::BaseClass );
...
{
  Usul::Interfaces::IClassFactory::ValidRefPtr factory ( new SnapShotFactory() );
...
SnapShotFactory::SnapShotFactory() : BaseClass()
{
}
...
Usul::Interfaces::IUnknown *SnapShotFactory::queryInterface ( unsigned long iid )
{
  switch ( iid )
  {
...
Usul::Interfaces::IUnknown *SnapShotFactory::createInstance ( unsigned long iid )
{
  // Require this to construct.
  SnapShotComponent::ValidAccessRefPtr component ( new SnapShotComponent() );
