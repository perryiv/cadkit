...
SgGlWinContextImpl::SgGlWinContextImpl() : 
  _window ( NULL ),
  _deviceContext ( NULL ),
  _glContext ( NULL )
{
  SL_PRINT2 ( "SgGlWinContextImpl::SgGlWinContextImpl(), this = %X\n", this );
}
...
bool SgGlWinContextImpl::create ( void *theWindow )
{
  SL_ASSERT ( this );
...
void SgGlWinContextImpl::_setPointersToNull()
{
  _window = NULL;
  _deviceContext = NULL;
  _glContext = NULL;
...
bool SgGlWinContextImpl::_deleteContext()
{
...
bool SgGlWinContextImpl::_releaseDeviceContext()
{
  SL_ASSERT ( this && _window && _deviceContext && !_glContext );
...
bool SgGlWinContextImpl::_deleteOpenGLContext()
{
  SL_ASSERT ( this && _window && _deviceContext && _glContext );
...
bool SgGlWinContextImpl::_selectSystemFont()
{
  SL_ASSERT ( this && _window && _deviceContext && _glContext );
...
bool SgGlWinContextImpl::_createContext ( HWND window )
{
...
HDC SgGlWinContextImpl::_getDeviceContext ( HWND window )
{
  SL_ASSERT ( window );
...
HGLRC SgGlWinContextImpl::_createOpenGLContext ( HDC deviceContext )
{
  SL_ASSERT ( deviceContext );
...
bool SgGlWinContextImpl::_setupPixelFormat ( HDC deviceContext )
{
  SL_ASSERT ( deviceContext );
...
int SgGlWinContextImpl::_getBestPixelFormatDesc ( HDC deviceContext, PIXELFORMATDESCRIPTOR &pixelFormatDescriptor )
{
  SL_ASSERT ( deviceContext );
...
bool SgGlWinContextImpl::makeCurrent()
{
  SL_ASSERT ( this && _window && _deviceContext && _glContext );
...
bool SgGlWinContextImpl::swapBuffers()
{
  // Should be true.
  SL_ASSERT ( _glContext     == ::wglGetCurrentContext() );
  SL_ASSERT ( _deviceContext == ::wglGetCurrentDC() );
