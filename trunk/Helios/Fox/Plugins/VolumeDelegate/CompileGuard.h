...
#ifndef _VOLUME_DELEGATE_COMPILE_GUARD_H_
#define _VOLUME_DELEGATE_COMPILE_GUARD_H_

#ifndef _COMPILING_VOLUME_DELEGATE
# error "This header file is only used for compiling the library."
# error "It should not be included in client code."
#endif

#endif // _VOLUME_DELEGATE_COMPILE_GUARD_H_
