...
#ifndef _POSTGIS_LAYER_QT_COMPILE_GUARD_H_
#define _POSTGIS_LAYER_QT_COMPILE_GUARD_H_

#ifndef _COMPILING_POSTGIS_LAYER_QT
# error "This header file is only used for compiling the library."
# error "It should not be included in client code."
#endif

#endif // _POSTGIS_LAYER_QT_COMPILE_GUARD_H_
