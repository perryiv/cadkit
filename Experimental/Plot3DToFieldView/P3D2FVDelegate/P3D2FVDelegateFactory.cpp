...
#include "P3D2FVDelegateFactory.h"
#include "P3D2FVDelegateComponent.h"

#include "Usul/Components/Create.h"

USUL_IMPLEMENT_IUNKNOWN_MEMBERS ( P3D2FVDelegateFactory, P3D2FVDelegateFactory::BaseClass );
...
{
  Usul::Interfaces::IClassFactory::ValidRefPtr factory ( new P3D2FVDelegateFactory() );
...
P3D2FVDelegateFactory::P3D2FVDelegateFactory() : BaseClass()
{
}
...
P3D2FVDelegateFactory::~P3D2FVDelegateFactory()
{
}
...
Usul::Interfaces::IUnknown *P3D2FVDelegateFactory::queryInterface ( unsigned long iid )
{
  switch ( iid )
  {
...
Usul::Interfaces::IUnknown *P3D2FVDelegateFactory::createInstance ( unsigned long iid )
{
  // Require this to construct.
  P3D2FVDelegateComponent::ValidAccessRefPtr component ( new P3D2FVDelegateComponent() );
