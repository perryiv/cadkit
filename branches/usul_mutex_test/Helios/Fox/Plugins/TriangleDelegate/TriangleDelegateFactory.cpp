...
#include "TriangleDelegateFactory.h"
#include "TriangleDelegateComponent.h"

#include "Usul/Components/Create.h"

USUL_IMPLEMENT_IUNKNOWN_MEMBERS ( TriangleDelegateFactory, TriangleDelegateFactory::BaseClass );
...
{
  Usul::Interfaces::IClassFactory::ValidRefPtr factory ( new TriangleDelegateFactory() );
...
TriangleDelegateFactory::TriangleDelegateFactory() : BaseClass()
{
}
...
TriangleDelegateFactory::~TriangleDelegateFactory()
{
}
...
Usul::Interfaces::IUnknown *TriangleDelegateFactory::queryInterface ( unsigned long iid )
{
  switch ( iid )
  {
...
Usul::Interfaces::IUnknown *TriangleDelegateFactory::createInstance ( unsigned long iid )
{
  // Require this to construct.
  TriangleDelegateComponent::ValidAccessRefPtr component ( new TriangleDelegateComponent() );
