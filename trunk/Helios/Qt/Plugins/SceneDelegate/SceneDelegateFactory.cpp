...
#include "Helios/Qt/Plugins/SceneDelegate/SceneDelegateComponent.h"
...
{
  Usul::Interfaces::IClassFactory::ValidRefPtr factory ( new Usul::Components::Factory<SceneDelegateComponent>() );
