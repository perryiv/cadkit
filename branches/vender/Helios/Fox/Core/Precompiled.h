...
#ifndef _OSG_FOX_CORE_INTERNAL_PRECOMPILED_HEADERS_H_
#define _OSG_FOX_CORE_INTERNAL_PRECOMPILED_HEADERS_H_

#ifndef _COMPILING_OSG_FOX_CORE
...
#endif // _OSG_FOX_CORE_INTERNAL_PRECOMPILED_HEADERS_H_
