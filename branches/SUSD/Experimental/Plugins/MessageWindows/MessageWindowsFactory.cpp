...
#include "MessageWindowsFactory.h"
#include "MessageWindowsComponent.h"
#include "Usul/Components/Create.h"



USUL_IMPLEMENT_IUNKNOWN_MEMBERS ( MessageWindowsFactory, MessageWindowsFactory::BaseClass );
...
{
  Usul::Interfaces::IClassFactory::ValidRefPtr factory ( new MessageWindowsFactory() );
...
MessageWindowsFactory::MessageWindowsFactory() : BaseClass()
{
}
...
MessageWindowsFactory::~MessageWindowsFactory()
{
}
...
Usul::Interfaces::IUnknown *MessageWindowsFactory::queryInterface ( unsigned long iid )
{
  switch ( iid )
  {
...
Usul::Interfaces::IUnknown *MessageWindowsFactory::createInstance ( unsigned long iid )
{
  // Require this to construct.
  MessageWindowsComponent::ValidAccessRefPtr component ( new MessageWindowsComponent() );
