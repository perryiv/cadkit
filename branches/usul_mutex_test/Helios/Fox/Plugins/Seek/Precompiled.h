...
#ifndef _VIEW_SEEK_INTERNAL_PRECOMPILED_HEADERS_H_
#define _VIEW_SEEK_INTERNAL_PRECOMPILED_HEADERS_H_

#ifndef _COMPILING_SEEK
...
#endif // _SEEK_INTERNAL_PRECOMPILED_HEADERS_H_
