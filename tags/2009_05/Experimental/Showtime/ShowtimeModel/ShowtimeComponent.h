...
class ShowtimeComponent : public Usul::Base::Referenced,
...
public:
  ...
  USUL_DECLARE_REF_POINTERS ( ShowtimeComponent );
  ...
  virtual std::string         getPluginName() const { return "Showtime Model"; }
...
protected: 
  ...
  friend class ShowtimeDocument;

  // Do not copy.
  ShowtimeComponent ( const ShowtimeComponent & );
  ShowtimeComponent &operator = ( const ShowtimeComponent & );

  // Use reference counting.
  virtual ~ShowtimeComponent();
