...
#include "ImageDelegateFactory.h"
#include "ImageDelegateComponent.h"

#include "Usul/Components/Create.h"

USUL_IMPLEMENT_IUNKNOWN_MEMBERS ( ImageDelegateFactory, ImageDelegateFactory::BaseClass );
...
{
  Usul::Interfaces::IClassFactory::ValidRefPtr factory ( new ImageDelegateFactory() );
...
ImageDelegateFactory::ImageDelegateFactory() : BaseClass()
{
}
...
ImageDelegateFactory::~ImageDelegateFactory()
{
}
...
Usul::Interfaces::IUnknown *ImageDelegateFactory::queryInterface ( unsigned long iid )
{
  switch ( iid )
  {
...
Usul::Interfaces::IUnknown *ImageDelegateFactory::createInstance ( unsigned long iid )
{
  // Require this to construct.
  ImageDelegateComponent::ValidAccessRefPtr component ( new ImageDelegateComponent() );
