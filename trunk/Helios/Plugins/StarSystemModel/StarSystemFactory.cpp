...
#include "StarSystemFactory.h"
#include "StarSystemComponent.h"

#include "Usul/Components/Create.h"
#include "Usul/Trace/Trace.h"

USUL_IMPLEMENT_IUNKNOWN_MEMBERS ( StarSystemFactory, StarSystemFactory::BaseClass );
...
{
  USUL_TRACE_SCOPE_STATIC;
  Usul::Interfaces::IClassFactory::ValidRefPtr factory ( new StarSystemFactory() );
...
StarSystemFactory::StarSystemFactory() : BaseClass()
{
  USUL_TRACE_SCOPE;
}
...
Usul::Interfaces::IUnknown *StarSystemFactory::queryInterface ( unsigned long iid )
{
  USUL_TRACE_SCOPE;
...
Usul::Interfaces::IUnknown *StarSystemFactory::createInstance ( unsigned long iid )
{
  USUL_TRACE_SCOPE;

  // Require this to construct.
  StarSystemComponent::ValidAccessRefPtr component ( new StarSystemComponent() );
