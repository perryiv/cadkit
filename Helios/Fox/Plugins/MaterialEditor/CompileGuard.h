...
#ifndef _MATERIAL_EDITOR_COMPILE_GUARD_H_
#define _MATERIAL_EDITOR_COMPILE_GUARD_H_

#ifndef _COMPILING_MATERIAL_EDITOR
# error "This header file is only used for compiling the library."
# error "It should not be included in client code."
#endif

#endif // _MATERIAL_EDITOR_COMPILE_GUARD_H_
