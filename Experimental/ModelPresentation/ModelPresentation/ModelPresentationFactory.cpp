...
#include "ModelPresentationFactory.h"
#include "ModelPresentationComponent.h"

#include "Usul/Components/Create.h"

USUL_IMPLEMENT_IUNKNOWN_MEMBERS ( ModelPresentationFactory, ModelPresentationFactory::BaseClass );
...
{
  Usul::Interfaces::IClassFactory::ValidRefPtr factory ( new ModelPresentationFactory() );
...
ModelPresentationFactory::ModelPresentationFactory() : BaseClass()
{
}
...
ModelPresentationFactory::~ModelPresentationFactory()
{
}
...
Usul::Interfaces::IUnknown *ModelPresentationFactory::queryInterface ( unsigned long iid )
{
  switch ( iid )
  {
...
Usul::Interfaces::IUnknown *ModelPresentationFactory::createInstance ( unsigned long iid )
{
  // Require this to construct.
  ModelPresentationComponent::ValidAccessRefPtr component ( new ModelPresentationComponent() );
