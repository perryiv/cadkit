...
#include "ParadisModelFactory.h"
#include "ParadisModelComponent.h"
#include "Usul/Components/Create.h"



USUL_IMPLEMENT_IUNKNOWN_MEMBERS ( ParadisModelFactory, ParadisModelFactory::BaseClass );
...
{
  Usul::Interfaces::IClassFactory::ValidRefPtr factory ( new ParadisModelFactory() );
...
ParadisModelFactory::ParadisModelFactory() : BaseClass()
{
}
...
ParadisModelFactory::~ParadisModelFactory()
{
}
...
Usul::Interfaces::IUnknown *ParadisModelFactory::queryInterface ( unsigned long iid )
{
  switch ( iid )
  {
...
Usul::Interfaces::IUnknown *ParadisModelFactory::createInstance ( unsigned long iid )
{
  // Require this to construct.
  ParadisModelComponent::ValidAccessRefPtr component ( new ParadisModelComponent() );
