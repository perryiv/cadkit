...
#include "DynamicLandDelegateFactory.h"
#include "DynamicLandDelegateComponent.h"

#include "Usul/Components/Create.h"

USUL_IMPLEMENT_IUNKNOWN_MEMBERS ( DynamicLandDelegateFactory, DynamicLandDelegateFactory::BaseClass );
...
{
  Usul::Interfaces::IClassFactory::ValidRefPtr factory ( new DynamicLandDelegateFactory() );
...
DynamicLandDelegateFactory::DynamicLandDelegateFactory() : BaseClass()
{
}
...
DynamicLandDelegateFactory::~DynamicLandDelegateFactory()
{
}
...
Usul::Interfaces::IUnknown *DynamicLandDelegateFactory::queryInterface ( unsigned long iid )
{
  switch ( iid )
  {
...
Usul::Interfaces::IUnknown *DynamicLandDelegateFactory::createInstance ( unsigned long iid )
{
  // Require this to construct.
  DynamicLandDelegateComponent::ValidAccessRefPtr component ( new DynamicLandDelegateComponent() );
