...
USUL_IMPLEMENT_IUNKNOWN_MEMBERS ( FoxFactory, FoxFactory::BaseClass );
USUL_IMPLEMENT_TYPE_ID ( FoxFactory );
...
{
  Usul::Interfaces::IClassFactory::ValidRefPtr factory ( new FoxFactory() );
...
FoxFactory::FoxFactory() : BaseClass()
{
}
...
Usul::Interfaces::IUnknown *FoxFactory::queryInterface ( unsigned long iid )
{
  switch ( iid )
  {
...
Usul::Interfaces::IUnknown *FoxFactory::createInstance ( unsigned long iid )
{
  // Require this to construct.
  FoxComponent::ValidAccessRefPtr component ( new FoxComponent() );
