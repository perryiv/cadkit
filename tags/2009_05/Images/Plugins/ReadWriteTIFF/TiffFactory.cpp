...
USUL_IMPLEMENT_IUNKNOWN_MEMBERS ( TiffFactory, TiffFactory::BaseClass );
...
{
  Usul::Interfaces::IClassFactory::ValidRefPtr factory ( new TiffFactory() );
...
TiffFactory::TiffFactory() : BaseClass()
{
}
...
Usul::Interfaces::IUnknown *TiffFactory::queryInterface ( unsigned long iid )
{
  switch ( iid )
  {
...
Usul::Interfaces::IUnknown *TiffFactory::createInstance ( unsigned long iid )
{
  // Require this to construct.
  TiffComponent::ValidAccessRefPtr component ( new TiffComponent() );
