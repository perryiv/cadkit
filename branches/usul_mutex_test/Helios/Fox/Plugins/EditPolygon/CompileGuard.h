...
#ifndef _DELETION_PRIMITIVE_COMPILE_GUARD_H_
#define _DELETION_PRIMITIVE_COMPILE_GUARD_H_

#ifndef _COMPILING_EDIT_POLYGON
# error "This header file is only used for compiling the library."
# error "It should not be included in client code."
#endif

#endif // _DELETION_PRIMITIVE_COMPILE_GUARD_H_
