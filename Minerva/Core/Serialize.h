...
inline Minerva::Core::Layers::Container * deserialize ( const std::string& xml )
{
  std::vector< Minerva::Core::Layers::Container::RefPtr > v;
...
inline void deserialize ( const std::string& xml, Minerva::Core::Layers::Container *layer )
{
