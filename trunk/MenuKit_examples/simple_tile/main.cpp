...
//  MenuKit::Menu::Ptr menu = create_menu();
  ...
  //MenuKit::OSG::BasicLayer::Ptr layer = new MenuKit::OSG::BasicLayer();

  // make the menu graphics
  //osg::ref_ptr<osg::Node> scene = (*gfx)( menu.get() );
  //menu->accept( *layer );
  //osg::ref_ptr<osg::Node> scene = layer->scene();

  OsgTools::ColorBox osgtcb;
  osg::ref_ptr<osg::Node> scene = osgtcb();
