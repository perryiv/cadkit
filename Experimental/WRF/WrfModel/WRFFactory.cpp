...
#include "WRFFactory.h"
#include "WRFComponent.h"

#include "Usul/Components/Create.h"

USUL_IMPLEMENT_IUNKNOWN_MEMBERS ( WRFFactory, WRFFactory::BaseClass );
...
{
  Usul::Interfaces::IClassFactory::ValidRefPtr factory ( new WRFFactory() );
...
WRFFactory::WRFFactory() : BaseClass()
{
}
...
Usul::Interfaces::IUnknown *WRFFactory::queryInterface ( unsigned long iid )
{
  switch ( iid )
  {
...
Usul::Interfaces::IUnknown *WRFFactory::createInstance ( unsigned long iid )
{
  // Require this to construct.
  WRFComponent::ValidAccessRefPtr component ( new WRFComponent() );
