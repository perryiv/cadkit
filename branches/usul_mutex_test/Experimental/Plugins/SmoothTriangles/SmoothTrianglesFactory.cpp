...
#include "SmoothTrianglesFactory.h"
#include "SmoothTrianglesComponent.h"
#include "Usul/Components/Create.h"



USUL_IMPLEMENT_IUNKNOWN_MEMBERS ( SmoothTrianglesFactory, SmoothTrianglesFactory::BaseClass );
...
{
  Usul::Interfaces::IClassFactory::ValidRefPtr factory ( new SmoothTrianglesFactory() );
...
SmoothTrianglesFactory::SmoothTrianglesFactory() : BaseClass()
{
}
...
SmoothTrianglesFactory::~SmoothTrianglesFactory()
{
}
...
Usul::Interfaces::IUnknown *SmoothTrianglesFactory::queryInterface ( unsigned long iid )
{
  switch ( iid )
  {
...
Usul::Interfaces::IUnknown *SmoothTrianglesFactory::createInstance ( unsigned long iid )
{
  // Require this to construct.
  SmoothTrianglesComponent::ValidAccessRefPtr component ( new SmoothTrianglesComponent() );
