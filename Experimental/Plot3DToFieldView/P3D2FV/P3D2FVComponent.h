...
class P3D2FVComponent : public Usul::Base::Referenced,
...
public:
  ...
  USUL_DECLARE_REF_POINTERS ( P3D2FVComponent );
  ...
  virtual std::string           getPluginName() const { return "Plot3D to FieldView Converter"; }
...
protected: 
  ...
  // Do not copy.
  P3D2FVComponent ( const P3D2FVComponent & );
  P3D2FVComponent &operator = ( const P3D2FVComponent & );

  /// Use reference counting.
  virtual ~P3D2FVComponent();
