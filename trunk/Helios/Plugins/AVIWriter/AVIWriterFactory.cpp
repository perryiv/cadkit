...
#include "AVIWriterFactory.h"
#include "AVIWriterComponent.h"
#include "Usul/Components/Create.h"



USUL_IMPLEMENT_IUNKNOWN_MEMBERS ( AVIWriterFactory, AVIWriterFactory::BaseClass );
...
{
  Usul::Interfaces::IClassFactory::ValidRefPtr factory ( new AVIWriterFactory() );
...
AVIWriterFactory::AVIWriterFactory() : BaseClass()
{
}
...
AVIWriterFactory::~AVIWriterFactory()
{
}
...
Usul::Interfaces::IUnknown *AVIWriterFactory::queryInterface ( unsigned long iid )
{
  switch ( iid )
  {
...
Usul::Interfaces::IUnknown *AVIWriterFactory::createInstance ( unsigned long iid )
{
  // Require this to construct.
  AVIWriterComponent::ValidAccessRefPtr component ( new AVIWriterComponent() );
