...
clobber:
	...
	rm -fr ii_files
	rm -f $(CADKIT_LIB_DIR)/$(TARGET)$(EXECUTABLE_EXTENSION)
...
release: $(OBJECTS)
	...
	mkdir -p $(CADKIT_LIB_DIR)
	mv $(TARGET)$(EXECUTABLE_EXTENSION) $(CADKIT_LIB_DIR)/.
...
debug: $(OBJECTS)
	...
	mkdir -p $(CADKIT_LIB_DIR)
	mv $(TARGET)d$(EXECUTABLE_EXTENSION) $(CADKIT_LIB_DIR)/.
	echo ----- Target $(TARGET) successfully built! -----
