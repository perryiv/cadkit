...
class USUL_EXPORT Options
{
 public:
   ...
   */
  std::string stringValue ( const std::string& option ) const;
   ...
   */
  unsigned long int intValue (const std::string& option) const;
   ...
   */
  float floatValue(const std::string& option) const;
