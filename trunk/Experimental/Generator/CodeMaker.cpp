...
void CodeMaker::_handleComponent ( const std::string& name, const std::string& plugin, const std::string& directory, std::string& errors )
{
...

  {
    Strings keys, values;
    keys.push_back ( "file" );
    values.push_back ( "Usul/Base/Referenced.h" );
...
void CodeMaker::_handleProjectFiles ( const std::string&, const std::string& plugin, const std::string& directory, std::string& errors )
{
  ...
  // Create Visual Studio 7.1 project file
  {
    ...
    this->_searchAndReplace ( "skeleton_vs71.xml", filename, strings );
  }

  // Create Visual Studio 8 project file
  {
    std::string filename ( directory + "/" + pluginName + "_vs8.vcproj" );
    this->_searchAndReplace ( "skeleton_vs80.xml", filename, strings );
  }
}
...
void CodeMaker::_transformXML       ( const std::string& xml, const std::string& xsltFile, const std::string& output, std::string& errors )
{
