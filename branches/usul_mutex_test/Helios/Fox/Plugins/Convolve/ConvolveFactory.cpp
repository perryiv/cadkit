...
USUL_IMPLEMENT_IUNKNOWN_MEMBERS ( ConvolveFactory, ConvolveFactory::BaseClass );
...
{
  Usul::Interfaces::IClassFactory::ValidRefPtr factory ( new ConvolveFactory() );
...
ConvolveFactory::ConvolveFactory() : BaseClass()
{
}
...
Usul::Interfaces::IUnknown *ConvolveFactory::queryInterface ( unsigned long iid )
{
  switch ( iid )
  {
...
Usul::Interfaces::IUnknown *ConvolveFactory::createInstance ( unsigned long iid )
{
  // Require this to construct.
  ConvolveComponent::ValidAccessRefPtr component ( new ConvolveComponent() );
