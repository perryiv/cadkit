...
USUL_IMPLEMENT_IUNKNOWN_MEMBERS ( DynamicLandDelegateComponent , DynamicLandDelegateComponent::BaseClass );
...
DynamicLandDelegateComponent::DynamicLandDelegateComponent() : BaseClass()
{
}
...
DynamicLandDelegateComponent::~DynamicLandDelegateComponent()
{
}
...
Usul::Interfaces::IUnknown *DynamicLandDelegateComponent::queryInterface ( unsigned long iid )
{
  switch ( iid )
  {
...
void DynamicLandDelegateComponent::createDefaultGUI ( Usul::Documents::Document *document, Usul::Interfaces::IUnknown* caller )
{
...
void DynamicLandDelegateComponent::refreshView ( Usul::Documents::Document *document, Usul::Interfaces::IViewer *viewer )
{
