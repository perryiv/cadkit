...
USUL_IMPLEMENT_IUNKNOWN_MEMBERS ( ThreadSafeProgressBar, ThreadSafeProgressBar::BaseClass );
...
class ThreadSafeProgressBarAnimationCallback : public osg::NodeCallback
{
public:

  ThreadSafeProgressBarAnimationCallback( ThreadSafeProgressBar* bar ) :
      _bar ( bar )     
    { 
    }
...
private:
  ThreadSafeProgressBar::RefPtr _bar;
...
ThreadSafeProgressBar::ThreadSafeProgressBar() : BaseClass(),
  _range   ( 0, 100 ),
  _value   ( 0 ),
  _barSize ( 0 ),
  _text    (),
...
ThreadSafeProgressBar::~ThreadSafeProgressBar()
{
}
...
Usul::Interfaces::IUnknown* ThreadSafeProgressBar::queryInterface ( unsigned long iid )
{
	switch ( iid )
	{
...
float ThreadSafeProgressBar::getLength()
{
  Guard guard ( this->mutex() );
  return _size[0];
}
...
float ThreadSafeProgressBar::getHeight()
{
  Guard guard ( this->mutex() );
  return _size[1];
}
...
Usul::Math::Vec2f ThreadSafeProgressBar::getLowerLeft() const 
{ 
  Guard guard ( this->mutex() );
...
void ThreadSafeProgressBar::setLowerLeft( const Usul::Math::Vec2f & ll )
{
  Guard guard ( this->mutex() );
  _pos[0] = ll[0];
  _pos[1] = ll[1];
...
void ThreadSafeProgressBar::setBarLengthAndHeight ( const Usul::Math::Vec2f& lh )
{
  Guard guard ( this->mutex() );
...
void ThreadSafeProgressBar::setAnimation ( bool value )
{
  Guard guard ( this->mutex() );
  _isAnimating = value;
}
...
bool ThreadSafeProgressBar::isAnimating() 
{ 
  Guard guard ( this->mutex() );
  return _isAnimating; 
}
...
bool ThreadSafeProgressBar::isVisible() 
{ 
  Guard guard ( this->mutex() );
  return _isVisible; 
}
...
bool ThreadSafeProgressBar::isFinished() 
{ 
  Guard guard ( this->mutex() );
  return _isFinished; 
}
...
float ThreadSafeProgressBar::getAnimationStep () 
{ 
  Guard guard ( this->mutex() );
...
float ThreadSafeProgressBar::getAnimationEnd () 
{ 
  Guard guard ( this->mutex() );
...
float ThreadSafeProgressBar::getAnimationCurrent () 
{ 
  Guard guard ( this->mutex() );
...
void ThreadSafeProgressBar::text ( const std::string &t )
{
  Guard guard ( this->mutex() );
  _text = t;
  this->_setDirty ( true );
...
Usul::Math::Vec2d ThreadSafeProgressBar::range() const
{
  Guard guard ( this->mutex() );
  return _range;
}
...
void ThreadSafeProgressBar::value ( double v )
{
  Guard guard ( this->mutex() );
...
double ThreadSafeProgressBar::value() const
{
  Guard guard ( this->mutex() );
  return _value;
}
...
Usul::Math::Vec2f ThreadSafeProgressBar::size() const
{
  Guard guard ( this->mutex() );
  return _size;
}
...
Usul::Math::Vec2f ThreadSafeProgressBar::padding() const
{
  Guard guard ( this->mutex() );
  return _padding;
}
...
std::string ThreadSafeProgressBar::text() const
{
  Guard guard ( this->mutex() );
  return _text;
}
...
osg::Node * ThreadSafeProgressBar::buildScene()
{
...
void ThreadSafeProgressBar::stepAnimation()
{
  Guard guard ( this->mutex() );
...
void ThreadSafeProgressBar::clear()
{
...
void ThreadSafeProgressBar::_setupAnimation( float cur, float end, float step )
{
  Guard guard ( this->mutex() );
...
void ThreadSafeProgressBar::_layout()
{
...
bool ThreadSafeProgressBar::_isDirty() const
{
  Guard guard ( this->mutex() );
  return _dirty;
}
...
void ThreadSafeProgressBar::_setDirty ( bool d )
{
  Guard guard ( this->mutex() );
  _dirty = d;
}
...
std::string ThreadSafeProgressBar::_getPercentComplete()
{
  Guard guard ( this->mutex() );
...
osg::Node * ThreadSafeProgressBar::_emptyScene()
{
  Guard guard ( this->mutex() );
...
osg::Node * ThreadSafeProgressBar::_buildScene()
{
  ...
  else
  {
    ...
    anim->setUpdateCallback ( new ThreadSafeProgressBarAnimationCallback ( this ) );
