...
USUL_IMPLEMENT_IUNKNOWN_MEMBERS ( DRTSimDelegateComponent, DRTSimDelegateComponent::BaseClass );
...
DRTSimDelegateComponent::DRTSimDelegateComponent() : BaseClass()
{
}
...
DRTSimDelegateComponent::~DRTSimDelegateComponent()
{
}
...
Usul::Interfaces::IUnknown *DRTSimDelegateComponent::queryInterface ( unsigned long iid )
{
  switch ( iid )
  {
...
bool DRTSimDelegateComponent::doesHandle( const std::string& token ) const
{
  return ( token == "DRT Simulation Document" );
}
...
void DRTSimDelegateComponent::createDefaultGUI ( Usul::Documents::Document *document, Usul::Interfaces::IUnknown* caller )
{
