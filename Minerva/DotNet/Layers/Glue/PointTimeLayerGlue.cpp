...
float PointTimeLayerGlue::SecondarySize::get()
{
  return _pointTimeLayer->secondarySize();
}
...
void PointTimeLayerGlue::SecondarySize::set ( float f )
{
  _pointTimeLayer->secondarySize ( f );
}
