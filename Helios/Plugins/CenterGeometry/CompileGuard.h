...
#ifndef _CENTER_GEOMETRY_COMPILE_GUARD_H_
#define _CENTER_GEOMETRY_COMPILE_GUARD_H_

#ifndef _COMPILING_CENTER_GEOMETRY
# error "This header file is only used for compiling the library."
# error "It should not be included in client code."
#endif

#endif // _CENTER_GEOMETRY_COMPILE_GUARD_H_
