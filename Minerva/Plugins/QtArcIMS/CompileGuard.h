...
#ifndef _ARC_IMS_LAYER_QT_COMPILE_GUARD_H_
#define _ARC_IMS_LAYER_QT_COMPILE_GUARD_H_

#ifndef _COMPILING_ARC_IMS_LAYER_QT
# error "This header file is only used for compiling the library."
# error "It should not be included in client code."
#endif

#endif // _ARC_IMS_LAYER_QT_COMPILE_GUARD_H_
